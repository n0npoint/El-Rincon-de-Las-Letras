...
class TbCategoriaxlibro(models.Model):
    id_libro = models.OneToOneField(TbLibros, models.DO_NOTHING, db_column='id_libro', primary_key=True)  # The composite primary key (id_libro, id_categoria) found, that is not supported. The first column is selected.
