    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_contratacion', models.DateTimeField(verbose_name='Fecha Contratación')),
                ('foto', models.ImageField(blank=True, default='empleados/empleado_empty.png', null=True, upload_to='empleados', verbose_name='Foto')),
