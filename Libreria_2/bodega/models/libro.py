...
class TbLibros(models.Model):
    ...
    sipnosis = models.TextField(max_length=200, blank=True, null=True , verbose_name='Sipnosis' , )
    ...
    caratula = models.ImageField(upload_to="libros" , default="libros/libro_general.jpg", blank=True, null=True, verbose_name='Portada')
